...
var generateDownloadLink = require('./index.js');

describe('When you invoke generate-download-link,', function() {
  before(function() {
    var opt = {
      data: 'nice data',
      title: 'nice title',
    ...
    this.anchor = generateDownloadLink(opt);
  });
  ...
  describe('creation', function() {
    it('should fail if data is missing', function() {
      ...
      assert.throw(function() {
        generateDownloadLink(opt);
      }, Error, 'No data provided to generate-download-link');
    });
    it('should fail if title is missing', function() {
      ...
      assert.throw(function() {
        generateDownloadLink(opt);
      }, Error, 'No title provided to generate-download-link');
    });
    it('should fail if filename is missing', function() {
      ...
      assert.throw(function() {
        generateDownloadLink(opt);
      }, Error, 'No filename provided to generate-download-link');
    });
  });
});
